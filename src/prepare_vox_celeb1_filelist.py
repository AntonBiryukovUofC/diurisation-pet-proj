...
def main(voxceleb_path= 'D:\\VoxCeleb/vox1_dev_wav/wav'):
    ...
    train[['short_path','class']].to_csv('../data/processed/voxlb1_train.txt',header=False,index=False,sep=' ')
    test[['short_path', 'class']].to_csv('../data/processed/voxlb1_val.txt',header=False,index = False,sep=' ')
