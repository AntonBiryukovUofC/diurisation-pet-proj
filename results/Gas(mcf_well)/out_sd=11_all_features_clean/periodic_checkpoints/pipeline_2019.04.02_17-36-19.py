...
# Average CV score on the training set was:0.7291468285032485
exported_pipeline = make_pipeline(
    ...
    LGBMRegressor(colsample_bytree=0.5, learning_rate=0.1, max_bin=63, max_depth=6, min_child_weight=5, n_estimators=350, num_leaves=8, objective="mse", reg_alpha=1.0, subsample=0.6, subsample_freq=0, verbosity=-1)
)
