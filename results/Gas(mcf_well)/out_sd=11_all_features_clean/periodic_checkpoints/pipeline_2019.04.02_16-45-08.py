...
# Average CV score on the training set was:0.7342577650185778
exported_pipeline = make_pipeline(
    ...
    LGBMRegressor(colsample_bytree=0.6, learning_rate=0.1, max_bin=31, max_depth=6, min_child_weight=15, n_estimators=350, num_leaves=128, objective="mse", reg_alpha=5, subsample=0.85, subsample_freq=0, verbosity=-1)
)
