...
# Average CV score on the training set was:0.7100781722893472
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=RandomForestRegressor(bootstrap=False, max_depth=7, max_features=0.8500000000000002, min_samples_leaf=0.15500000000000003, min_samples_split=0.405, n_estimators=400)),
    MinMaxScaler(),
