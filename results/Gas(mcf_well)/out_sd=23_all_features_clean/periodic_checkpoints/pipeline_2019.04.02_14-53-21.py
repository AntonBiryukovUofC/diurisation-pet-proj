...
# Average CV score on the training set was:0.6753530559717047
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_depth=4, max_features=0.5500000000000002, min_samples_leaf=0.255, min_samples_split=0.30500000000000005, n_estimators=400)),
