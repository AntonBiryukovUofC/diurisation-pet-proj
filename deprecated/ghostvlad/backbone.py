...
def resnet_2D_v1(input_dim, mode="train"):
    ...
    # ===============================================
    x2 = conv_block_2D(
        x1, 3, [48, 48, 96], stage=2, block="a", strides=(1, 1), trainable=True
    )
...
def resnet_2D_v2(input_dim, mode="train"):
    ...
    # ===============================================
    x2 = conv_block_2D(
        x1, 3, [64, 64, 256], stage=2, block="a", strides=(1, 1), trainable=True
    )
    ...
    # ===============================================
    x4 = conv_block_2D(
        x3, 3, [256, 256, 1024], stage=4, block="a", strides=(1, 1), trainable=True
    )
