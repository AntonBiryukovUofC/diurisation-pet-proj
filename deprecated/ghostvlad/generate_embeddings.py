...
def load_data(
    ...
    while True:
        ...
        if (
            cur_spec + win_spec // 2 > change_points[i]
...
def main():
    ...
    total_list = [
        os.path.join(args.data_path, file) for file in os.listdir(args.data_path)
    ]
    ...
    for epoch in range(7000):  # Random choice utterances from whole wavfiles
        ...
        print(
            "epoch:{}, utterance length: {}, speakers: {}".format(
